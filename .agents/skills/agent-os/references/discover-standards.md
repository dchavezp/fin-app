...
4. Create or update the file in `docs/standards/[folder]/`
...
1. Scan `docs/standards/` for all `.md` files
...
3. Update `docs/standards/index.yml`:
...
All standards: `docs/standards/[folder]/[standard].md`
Index file: `docs/standards/index.yml`
