...
Establish foundational product documentation through an interactive conversation. Creates mission, roadmap, and tech stack files in `docs/product/`.
...
Check if `docs/product/` exists and contains any of these files:
- `mission.md`
- `roadmap.md`
- `tech-stack.md`
...
First, check if `docs/standards/global/tech-stack.md` exists.
